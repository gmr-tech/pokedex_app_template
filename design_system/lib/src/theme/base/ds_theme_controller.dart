...
class DSThemeController extends ChangeNotifier {
  ...
  ///dsThemeMode: Um getter para obter o modo de tema atual, representado por um
  ///enum DSThemeMode que possui dois valores possíveis: light (claro) e
  ///dark (escuro).
  DSThemeMode get dsThemeMode => _dsThemeMode;

  ///themeMode: Um getter para obter o ThemeMode atual, que é um enum do Flutter
  ///que representa o modo de tema do Flutter. Pode ser ThemeMode.light (claro),
  ...
  ///_toggleThemeMode(DSThemeMode newMode): Um método privado que atualiza
  ...
  ///_toggleThemeData(DSThemeMode newMode): Um método privado que atualiza
