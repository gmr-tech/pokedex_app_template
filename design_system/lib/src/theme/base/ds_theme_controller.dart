...
class DSThemeController extends ChangeNotifier {
  ...
  /// significa que o tema do app será definido como escuro no início, seguindo
  /// o valor de _dsThemeMode.
  ...
  /// chamado, o controlador atualiza internamente o dsThemeMode, os dados de
  /// tema do projeto _themeData, o modo de tema do projeto _themeMode e
  /// notifica os ouvintes sobre a mudança, utilizando o notifyListeners().
